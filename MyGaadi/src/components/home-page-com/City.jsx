        ...
        <div className="left-section">
          ...
          <div className="city-grid">
            {cities.map((city, index) => (
              <div key={index} className="city-card"  onClick={()=>{navigate(`/Home/filtercar`, { state: { city } })}}>
                {city.name}
                <img
                  src={city.icon}
                  alt={`${city.name} icon`}
        ...
        <div className="right-section">
          ...
          <div className="input-wrapper">
            <input
              ...
              className="city-name"
              onChange={e => {const selectedCity = { name: e.target.value }; // or from dropdown options
          ...
          <div className="search-button-wrapper">
            ...
            <button onClick={()=>{navigate(`/Home/filtercar`, { state: { city } })}} className="search-button">Search Cars</button>
          </div>
