...
const FilterCar = () => {
  ...
  useEffect(() => {
    axios.post(`http://localhost:8080/cars/filter`, body) // your backend endpoint
      .then((res) => {
  ...
  return (
    <div className="carousel-container">
      <button onClick={handlePrev} disabled={startIndex <= 1} className="nav-btn">←</button>
        ...
        return (
          ...
          >
            ...
            <div className="car-info">
              ...
              <p>{car.registrationYear} • {car.fuelType} • {car.transmission}</p>
              <p>{car.kmDriven} km • {car.ownership} Owner</p>
