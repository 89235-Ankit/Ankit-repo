      ...
      <form className="car-form" onSubmit={handleSubmit}>
        ...
        <div className="form-grid">
          ...
          <input
            ...
            value={car.model}
          />
          <input name="variant" placeholder="Variant" onChange={handleChange}  value={car.variant} />
          <input
          ...
          />
          <select name="ownership"  value={car.ownership} onChange={handleChange}>
          ...
          />
          <input name="color" placeholder="Color" onChange={handleChange}  value={car.color}/>
          ...
          <select name="transmission" onChange={handleChange}  value={car.transmission}>
