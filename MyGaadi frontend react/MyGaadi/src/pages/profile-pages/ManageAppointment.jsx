...
const ManageAppointments = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/appointment/manage`, {
            headers: {
                    ...
                    {appointments.map((appt) => (
                        <div key={appt.id} className="appointment-card">
                            ...
                            <div className="car-info">
                                <p><strong>Car:</strong> {appt.carBrand} {appt.carModel} ({appt.carVariant})</p>
                            </div>

                            <div className="people-info">
                                <p><strong>Seller:</strong> {appt.sellerName} ({appt.sellerEmail})</p>
                                <p><strong>Buyer:</strong> {appt.buyerName} ({appt.buyerEmail})</p>

                            </div>


                            <p className="created-at">Booked on: {new Date(appt.createdAt).toLocaleString()}</p>
                            <div className="button-bar">
                                ...
                                <button
                                    ...
                                    onClick={() => handleclick(appt.id, selectedStatusMap[appt.id] || appt.status)}
                                >
                                    🔄 Update
                                </button>
